...
if (isset($_POST['submit'])) {
  ...
  // update data berdasarkan id_produk yg dikirimkan
	...
	$query = "INSERT INTO transaksi (ID_TRANSAKSI,ID_KASIR,ID_KUSTOMER,TGL_TRANSAKSI,NAMA_TRANSAKSI,HARGA_TRANSAKSI,JMLH_BRG,TOTAL_PEMBAYARAN) VALUES ('".$id."','".$ID_KASIR."','".$ID_KUSTOMER."','".$TGL_TRANSAKSI."','".$NAMA_TRANSAKSI."','".$HARGA_TRANSAKSI."','".$JMLH_BRG."','".$TOTAL_PEMBAYARAN."')";
